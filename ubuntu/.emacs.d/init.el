...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (elpy auto-virtualenvwrapper virtualenvwrapper nadvice python-mode magit yatex helm-ag-r json-rpc ace-jump-mode neotree undo-tree scheme python helm xpm xelb volatile-highlights use-package sly ruby-end ruby-electric recentf-ext rainbow-mode markdown-mode magic-filetype key-combo key-chord json-mode js2-mode inf-ruby helm-ag haskell-mode go-mode geben-helm-projectile flycheck evil-magit enh-ruby-mode display-theme counsel-projectile auto-complete add-hooks)))
